...
class Parser_codtrabajo extends Parser_planilla{
		
	function __construct(){
		parent::__construct();
                $this->CI->load->model('Codtrabajo_model');
		$this->model=$this->CI->Codtrabajo_model;
                $this->nombre_pagina='codtrabajo';
                $this->nombre='Personal Codigo Trabajo';
